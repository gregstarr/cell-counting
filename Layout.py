...
class Mixin:
    def setupLayout(self):
        ...
        redVb = pg.ViewBox(lockAspect=True)
        redVb.addItem(self.redBackgroundImage)
        redVb.addItem(self.redCellImage)
        redVb.addItem(self.redHoverImage)
        redView.setCentralItem(redVb)
        ...
        greenVb = pg.ViewBox(lockAspect=True)
        greenVb.addItem(self.greenBackgroundImage)
        greenVb.addItem(self.greenCellImage)
        greenVb.addItem(self.greenHoverImage)
        greenView.setCentralItem(greenVb)
        ...
        blueVb = pg.ViewBox(lockAspect=True)
        blueVb.addItem(self.blueBackgroundImage)
        blueView.setCentralItem(blueVb)
